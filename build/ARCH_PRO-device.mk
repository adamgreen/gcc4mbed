...
TARGETS_FOR_DEVICE := $(BUILD_TYPE_TARGET) TARGET_UVISOR_UNSUPPORTED TARGET_ARCH_PRO TARGET_CORTEX_M TARGET_LIKE_CORTEX_M3 TARGET_LPC176X TARGET_LPCTarget TARGET_M3 TARGET_NXP
...
ARCH_PRO_LSCRIPT  ?= $(call find_target_linkscript,$(DEVICE_MBED_DIRS))
LSCRIPT := $(ARCH_PRO_LSCRIPT)

...
TARGETS_FOR_DEVICE := $(BUILD_TYPE_TARGET) TARGET_UVISOR_UNSUPPORTED TARGET_CORTEX_M TARGET_DELTA_DFCM_NNN40 TARGET_LIKE_CORTEX_M0 TARGET_M0 TARGET_MCU_NORDIC_32K TARGET_MCU_NRF51 TARGET_MCU_NRF51822 TARGET_MCU_NRF51_32K TARGET_NORDIC
FEATURES_FOR_DEVICE := FEATURE_BLE
PERIPHERALS_FOR_DEVICE := DEVICE_ANALOGIN DEVICE_DEBUG_AWARENESS DEVICE_ERROR_PATTERN DEVICE_I2C DEVICE_INTERRUPTIN DEVICE_PORTIN DEVICE_PORTINOUT DEVICE_PORTOUT DEVICE_PWMOUT DEVICE_RTC DEVICE_SERIAL DEVICE_SLEEP DEVICE_SPI DEVICE_SPISLAVE
...
GCC_DEFINES += -DCMSIS_VECTAB_VIRTUAL -DCMSIS_VECTAB_VIRTUAL_HEADER_FILE=\"cmsis_nvic.h\" -DNRF51 -DTARGET_MCU_NORDIC_32K -DTARGET_MCU_NRF51_32K -DTARGET_NRF51822 -DTARGET_NRF_LFCLK_RC
...
DELTA_DFCM_NNN40_LSCRIPT  ?= $(call find_target_linkscript,$(DEVICE_MBED_DIRS))
LSCRIPT := $(DELTA_DFCM_NNN40_LSCRIPT)

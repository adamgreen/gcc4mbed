...
MBED_DEVICE        := DELTA_DFCM_NNN40_BOOT
...
TARGETS_FOR_DEVICE := $(BUILD_TYPE_TARGET) TARGET_UVISOR_UNSUPPORTED TARGET_CORTEX_M TARGET_DELTA_DFCM_NNN40 TARGET_DELTA_DFCM_NNN40_BOOT TARGET_LIKE_CORTEX_M0 TARGET_M0 TARGET_MCU_NORDIC_32K TARGET_MCU_NRF51 TARGET_MCU_NRF51822 TARGET_MCU_NRF51_32K TARGET_MCU_NRF51_32K_BOOT TARGET_NORDIC
...
GCC_DEFINES += -DCMSIS_VECTAB_VIRTUAL -DCMSIS_VECTAB_VIRTUAL_HEADER_FILE=\"cmsis_nvic.h\" -DNRF51 -DTARGET_DELTA_DFCM_NNN40 -DTARGET_MCU_NORDIC_32K -DTARGET_MCU_NRF51_32K -DTARGET_MCU_NRF51_32K_BOOT -DTARGET_NRF51822 -DTARGET_NRF_LFCLK_RC -DTARGET_OTA_ENABLED
...
DELTA_DFCM_NNN40_BOOT_LSCRIPT  ?= $(call find_target_linkscript,$(DEVICE_MBED_DIRS))
LSCRIPT := $(DELTA_DFCM_NNN40_BOOT_LSCRIPT)

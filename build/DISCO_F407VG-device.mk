...
TARGETS_FOR_DEVICE := $(BUILD_TYPE_TARGET) TARGET_UVISOR_UNSUPPORTED TARGET_CORTEX_M TARGET_DISCO_F407VG TARGET_LIKE_CORTEX_M4 TARGET_M4 TARGET_RTOS_M4_M7 TARGET_STM TARGET_STM32F4 TARGET_STM32F407 TARGET_STM32F407VG TARGET_STM32F407xG
FEATURES_FOR_DEVICE :=
PERIPHERALS_FOR_DEVICE := DEVICE_ANALOGIN DEVICE_ANALOGOUT DEVICE_ERROR_RED DEVICE_I2C DEVICE_I2CSLAVE DEVICE_I2C_ASYNCH DEVICE_INTERRUPTIN DEVICE_PORTIN DEVICE_PORTINOUT DEVICE_PORTOUT DEVICE_PWMOUT DEVICE_RTC DEVICE_SERIAL DEVICE_SLEEP DEVICE_SPI DEVICE_SPISLAVE DEVICE_SPI_ASYNCH DEVICE_STDIO_MESSAGES
...
GCC_DEFINES += -DTRANSACTION_QUEUE_SIZE_SPI=2 -DUSB_STM_HAL
...
DISCO_F407VG_LSCRIPT  ?= $(call find_target_linkscript,$(DEVICE_MBED_DIRS))

...
TARGETS_FOR_DEVICE := $(BUILD_TYPE_TARGET) TARGET_UVISOR_UNSUPPORTED TARGET_CORTEX_M TARGET_DISCO_F429ZI TARGET_FAMILY_STM32 TARGET_LIKE_CORTEX_M4 TARGET_M4 TARGET_RTOS_M4_M7 TARGET_STM TARGET_STM32F4 TARGET_STM32F429 TARGET_STM32F429ZI TARGET_STM32F429xI TARGET_STM32F429xx
FEATURES_FOR_DEVICE :=
...
DISCO_F429ZI_CLOCK_SOURCE ?= "USE_PLL_HSE_XTAL|USE_PLL_HSI"
GCC_DEFINES += -DCLOCK_SOURCE=$(DISCO_F429ZI_CLOCK_SOURCE)

# As 48 Mhz clock is configured for USB, SYSCLK has to be reduced from 180 to 168 MHz (set 0 for the max SYSCLK value)
DISCO_F429ZI_CLOCK_SOURCE_USB ?= "1"
GCC_DEFINES += -DCLOCK_SOURCE_USB=$(DISCO_F429ZI_CLOCK_SOURCE_USB)

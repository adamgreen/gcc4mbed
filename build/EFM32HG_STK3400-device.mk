...
TARGETS_FOR_DEVICE := $(BUILD_TYPE_TARGET) TARGET_UVISOR_UNSUPPORTED TARGET_64K TARGET_CORTEX_M TARGET_EFM32 TARGET_EFM32HG TARGET_EFM32HG322F64 TARGET_EFM32HG_STK3400 TARGET_LIKE_CORTEX_M0 TARGET_M0P TARGET_SL_AES TARGET_Silicon_Labs
FEATURES_FOR_DEVICE :=
...
GCC_DEFINES += -DEFM32HG322F64 -DTRANSACTION_QUEUE_SIZE_SPI=0

# Value: HFXO for external crystal, HFRCO for internal RC oscillator
EFM32HG_STK3400_CORE_CLOCK_SOURCE ?= "HFXO"
GCC_DEFINES += -DCORE_CLOCK_SOURCE=$(EFM32HG_STK3400_CORE_CLOCK_SOURCE)

# Value: External crystal frequency in hertz
EFM32HG_STK3400_HFXO_FREQUENCY ?= "24000000"
GCC_DEFINES += -DHFXO_FREQUENCY=$(EFM32HG_STK3400_HFXO_FREQUENCY)

# Value: LFXO for external crystal, LFRCO for internal RC oscillator, ULFRCO for internal 1KHz RC oscillator
EFM32HG_STK3400_LOW_ENERGY_CLOCK_SOURCE ?= "LFXO"
GCC_DEFINES += -DLOW_ENERGY_CLOCK_SOURCE=$(EFM32HG_STK3400_LOW_ENERGY_CLOCK_SOURCE)

# Value: External crystal frequency in hertz
EFM32HG_STK3400_LFXO_FREQUENCY ?= "32768"
GCC_DEFINES += -DLFXO_FREQUENCY=$(EFM32HG_STK3400_LFXO_FREQUENCY)

# Value: Frequency in hertz, must correspond to setting of hfrco_band_select
EFM32HG_STK3400_HFRCO_FREQUENCY ?= "21000000"
GCC_DEFINES += -DHFRCO_FREQUENCY=$(EFM32HG_STK3400_HFRCO_FREQUENCY)
...
EFM32HG_STK3400_HFRCO_FREQUENCY_ENUM ?= "_CMU_HFRCOCTRL_BAND_21MHZ"
GCC_DEFINES += -DHFRCO_FREQUENCY_ENUM=$(EFM32HG_STK3400_HFRCO_FREQUENCY_ENUM)

# Pin to pull high for enabling the USB serial port
EFM32HG_STK3400_EFM_BC_EN ?= "PA9"
GCC_DEFINES += -DEFM_BC_EN=$(EFM32HG_STK3400_EFM_BC_EN)
...
EFM32HG_STK3400_LSCRIPT  ?= $(call find_target_linkscript,$(DEVICE_MBED_DIRS))
LSCRIPT := $(EFM32HG_STK3400_LSCRIPT)

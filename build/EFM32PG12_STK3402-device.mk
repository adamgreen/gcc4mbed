...
TARGETS_FOR_DEVICE := $(BUILD_TYPE_TARGET) TARGET_UVISOR_UNSUPPORTED TARGET_1024K TARGET_CORTEX_M TARGET_EFM32 TARGET_EFM32PG12 TARGET_EFM32PG12B500F1024GL125 TARGET_EFM32PG12_STK3402 TARGET_LIKE_CORTEX_M4 TARGET_M4 TARGET_RTOS_M4_M7 TARGET_SL_CRYPTO TARGET_Silicon_Labs
FEATURES_FOR_DEVICE :=
PERIPHERALS_FOR_DEVICE := DEVICE_ANALOGIN DEVICE_ERROR_PATTERN DEVICE_FLASH DEVICE_I2C DEVICE_I2CSLAVE DEVICE_I2C_ASYNCH DEVICE_INTERRUPTIN DEVICE_LOWPOWERTIMER DEVICE_PORTIN DEVICE_PORTINOUT DEVICE_PORTOUT DEVICE_PWMOUT DEVICE_RTC DEVICE_SERIAL DEVICE_SERIAL_ASYNCH DEVICE_SLEEP DEVICE_SPI DEVICE_SPISLAVE DEVICE_SPI_ASYNCH DEVICE_STDIO_MESSAGES DEVICE_TRNG
...
GCC_DEFINES += -DEFM32PG12B500F1024GL125 -DTRANSACTION_QUEUE_SIZE_SPI=4

# Value: HFXO for external crystal, HFRCO for internal RC oscillator
EFM32PG12_STK3402_CORE_CLOCK_SOURCE ?= "HFXO"
GCC_DEFINES += -DCORE_CLOCK_SOURCE=$(EFM32PG12_STK3402_CORE_CLOCK_SOURCE)

# Value: External crystal frequency in hertz
EFM32PG12_STK3402_HFXO_FREQUENCY ?= "40000000"
GCC_DEFINES += -DHFXO_FREQUENCY=$(EFM32PG12_STK3402_HFXO_FREQUENCY)

# Value: LFXO for external crystal, LFRCO for internal RC oscillator, ULFRCO for internal 1KHz RC oscillator
EFM32PG12_STK3402_LOW_ENERGY_CLOCK_SOURCE ?= "LFXO"
GCC_DEFINES += -DLOW_ENERGY_CLOCK_SOURCE=$(EFM32PG12_STK3402_LOW_ENERGY_CLOCK_SOURCE)

# Value: External crystal frequency in hertz
EFM32PG12_STK3402_LFXO_FREQUENCY ?= "32768"
GCC_DEFINES += -DLFXO_FREQUENCY=$(EFM32PG12_STK3402_LFXO_FREQUENCY)

# Value: Frequency in hertz, must correspond to setting of hfrco_band_select
EFM32PG12_STK3402_HFRCO_FREQUENCY ?= "32000000"
GCC_DEFINES += -DHFRCO_FREQUENCY=$(EFM32PG12_STK3402_HFRCO_FREQUENCY)
...
EFM32PG12_STK3402_HFRCO_FREQUENCY_ENUM ?= "cmuHFRCOFreq_32M0Hz"
GCC_DEFINES += -DHFRCO_FREQUENCY_ENUM=$(EFM32PG12_STK3402_HFRCO_FREQUENCY_ENUM)

# Pin to pull high for enabling the USB serial port
EFM32PG12_STK3402_EFM_BC_EN ?= "PA5"
GCC_DEFINES += -DEFM_BC_EN=$(EFM32PG12_STK3402_EFM_BC_EN)
...
EFM32PG12_STK3402_LSCRIPT  ?= $(call find_target_linkscript,$(DEVICE_MBED_DIRS))
LSCRIPT := $(EFM32PG12_STK3402_LSCRIPT)

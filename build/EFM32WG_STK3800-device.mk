...
TARGETS_FOR_DEVICE := $(BUILD_TYPE_TARGET) TARGET_UVISOR_UNSUPPORTED TARGET_256K TARGET_CORTEX_M TARGET_EFM32 TARGET_EFM32WG TARGET_EFM32WG990F256 TARGET_EFM32WG_STK3800 TARGET_LIKE_CORTEX_M4 TARGET_M4 TARGET_RTOS_M4_M7 TARGET_SL_AES TARGET_Silicon_Labs
FEATURES_FOR_DEVICE :=
PERIPHERALS_FOR_DEVICE := DEVICE_ANALOGIN DEVICE_ANALOGOUT DEVICE_ERROR_PATTERN DEVICE_FLASH DEVICE_I2C DEVICE_I2CSLAVE DEVICE_I2C_ASYNCH DEVICE_INTERRUPTIN DEVICE_LOWPOWERTIMER DEVICE_PORTIN DEVICE_PORTINOUT DEVICE_PORTOUT DEVICE_PWMOUT DEVICE_RTC DEVICE_SERIAL DEVICE_SERIAL_ASYNCH DEVICE_SLEEP DEVICE_SPI DEVICE_SPISLAVE DEVICE_SPI_ASYNCH DEVICE_STDIO_MESSAGES
...
GCC_DEFINES += -DEFM32WG990F256 -DTRANSACTION_QUEUE_SIZE_SPI=4

# Value: HFXO for external crystal, HFRCO for internal RC oscillator
EFM32WG_STK3800_CORE_CLOCK_SOURCE ?= "HFXO"
GCC_DEFINES += -DCORE_CLOCK_SOURCE=$(EFM32WG_STK3800_CORE_CLOCK_SOURCE)

# Value: External crystal frequency in hertz
EFM32WG_STK3800_HFXO_FREQUENCY ?= "48000000"
GCC_DEFINES += -DHFXO_FREQUENCY=$(EFM32WG_STK3800_HFXO_FREQUENCY)

# Value: LFXO for external crystal, LFRCO for internal RC oscillator, ULFRCO for internal 1KHz RC oscillator
EFM32WG_STK3800_LOW_ENERGY_CLOCK_SOURCE ?= "LFXO"
GCC_DEFINES += -DLOW_ENERGY_CLOCK_SOURCE=$(EFM32WG_STK3800_LOW_ENERGY_CLOCK_SOURCE)

# Value: External crystal frequency in hertz
EFM32WG_STK3800_LFXO_FREQUENCY ?= "32768"
GCC_DEFINES += -DLFXO_FREQUENCY=$(EFM32WG_STK3800_LFXO_FREQUENCY)

# Value: Frequency in hertz, must correspond to setting of hfrco_band_select
EFM32WG_STK3800_HFRCO_FREQUENCY ?= "21000000"
GCC_DEFINES += -DHFRCO_FREQUENCY=$(EFM32WG_STK3800_HFRCO_FREQUENCY)
...
EFM32WG_STK3800_HFRCO_FREQUENCY_ENUM ?= "_CMU_HFRCOCTRL_BAND_21MHZ"
GCC_DEFINES += -DHFRCO_FREQUENCY_ENUM=$(EFM32WG_STK3800_HFRCO_FREQUENCY_ENUM)

# Pin to pull high for enabling the USB serial port
EFM32WG_STK3800_EFM_BC_EN ?= "PF7"
GCC_DEFINES += -DEFM_BC_EN=$(EFM32WG_STK3800_EFM_BC_EN)
...
EFM32WG_STK3800_LSCRIPT  ?= $(call find_target_linkscript,$(DEVICE_MBED_DIRS))
LSCRIPT := $(EFM32WG_STK3800_LSCRIPT)

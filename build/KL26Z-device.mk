...
TARGETS_FOR_DEVICE := $(BUILD_TYPE_TARGET) TARGET_UVISOR_UNSUPPORTED TARGET_CORTEX_M TARGET_Freescale TARGET_KL26Z TARGET_KLXX TARGET_LIKE_CORTEX_M0 TARGET_M0P
FEATURES_FOR_DEVICE :=
...
KL26Z_LSCRIPT  ?= $(call find_target_linkscript,$(DEVICE_MBED_DIRS))
LSCRIPT := $(KL26Z_LSCRIPT)

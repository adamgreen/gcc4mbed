...
TARGETS_FOR_DEVICE := $(BUILD_TYPE_TARGET) TARGET_UVISOR_UNSUPPORTED TARGET_CORTEX_M TARGET_FRDM TARGET_Freescale TARGET_KL43Z TARGET_KSDK2_MCUS TARGET_LIKE_CORTEX_M0 TARGET_M0P TARGET_MCUXpresso_MCUS
FEATURES_FOR_DEVICE :=
...
GCC_DEFINES += -DCPU_MKL43Z256VLH4 -DFSL_RTOS_MBED
...
KL43Z_LSCRIPT  ?= $(call find_target_linkscript,$(DEVICE_MBED_DIRS))
LSCRIPT := $(KL43Z_LSCRIPT)

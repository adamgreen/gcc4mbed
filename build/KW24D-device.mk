...
TARGETS_FOR_DEVICE := $(BUILD_TYPE_TARGET) TARGET_UVISOR_UNSUPPORTED TARGET_CORTEX_M TARGET_FRDM TARGET_Freescale TARGET_KSDK2_MCUS TARGET_KW24D TARGET_LIKE_CORTEX_M4 TARGET_M4 TARGET_MCUXpresso_MCUS TARGET_RTOS_M4_M7
FEATURES_FOR_DEVICE :=
PERIPHERALS_FOR_DEVICE := DEVICE_ANALOGIN DEVICE_ERROR_RED DEVICE_I2C DEVICE_I2CSLAVE DEVICE_INTERRUPTIN DEVICE_LOWPOWERTIMER DEVICE_PORTIN DEVICE_PORTINOUT DEVICE_PORTOUT DEVICE_PWMOUT DEVICE_RTC DEVICE_SERIAL DEVICE_SERIAL_FC DEVICE_SLEEP DEVICE_SPI DEVICE_SPISLAVE DEVICE_STDIO_MESSAGES DEVICE_TRNG
...
GCC_DEFINES += -DCPU_MKW24D512VHA5 -DFSL_RTOS_MBED
...
KW24D_LSCRIPT  ?= $(call find_target_linkscript,$(DEVICE_MBED_DIRS))
LSCRIPT := $(KW24D_LSCRIPT)

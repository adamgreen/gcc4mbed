...
TARGETS_FOR_DEVICE := $(BUILD_TYPE_TARGET) TARGET_UVISOR_UNSUPPORTED TARGET_CORTEX_M TARGET_FRDM TARGET_Freescale TARGET_KSDK2_MCUS TARGET_KW41Z TARGET_LIKE_CORTEX_M0 TARGET_M0P TARGET_MCUXpresso_MCUS
FEATURES_FOR_DEVICE :=
PERIPHERALS_FOR_DEVICE := DEVICE_ANALOGIN DEVICE_ANALOGOUT DEVICE_ERROR_RED DEVICE_I2C DEVICE_I2CSLAVE DEVICE_INTERRUPTIN DEVICE_PORTIN DEVICE_PORTINOUT DEVICE_PORTOUT DEVICE_PWMOUT DEVICE_RTC DEVICE_SERIAL DEVICE_SLEEP DEVICE_SPI DEVICE_SPISLAVE DEVICE_STDIO_MESSAGES DEVICE_TRNG
...
GCC_DEFINES += -DCPU_MKW41Z512VHT4 -DFSL_RTOS_MBED
...
KW41Z_LSCRIPT  ?= $(call find_target_linkscript,$(DEVICE_MBED_DIRS))
LSCRIPT := $(KW41Z_LSCRIPT)

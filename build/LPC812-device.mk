...
TARGETS_FOR_DEVICE := $(BUILD_TYPE_TARGET) TARGET_UVISOR_UNSUPPORTED TARGET_CORTEX_M TARGET_LIKE_CORTEX_M0 TARGET_LPC812 TARGET_LPC81X TARGET_LPCTarget TARGET_M0P TARGET_NXP
FEATURES_FOR_DEVICE :=
...
LPC812_LSCRIPT  ?= $(call find_target_linkscript,$(DEVICE_MBED_DIRS))
LSCRIPT := $(LPC812_LSCRIPT)

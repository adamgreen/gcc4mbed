...
TARGETS_FOR_DEVICE := $(BUILD_TYPE_TARGET) TARGET_UVISOR_UNSUPPORTED TARGET_CORTEX_M TARGET_LIKE_CORTEX_M4 TARGET_M4 TARGET_MAX32630 TARGET_MAX32630FTHR TARGET_Maxim TARGET_RTOS_M4_M7
FEATURES_FOR_DEVICE :=
...
GCC_DEFINES += -DTARGET=MAX32630 -DTARGET_REV=0x4132 -D__SYSTEM_HFX=96000000
...
MAX32630FTHR_LSCRIPT  ?= $(call find_target_linkscript,$(DEVICE_MBED_DIRS))
LSCRIPT := $(MAX32630FTHR_LSCRIPT)

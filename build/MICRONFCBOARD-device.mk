...
TARGETS_FOR_DEVICE := $(BUILD_TYPE_TARGET) TARGET_UVISOR_UNSUPPORTED TARGET_APPNEARME_MICRONFCBOARD TARGET_CORTEX_M TARGET_LIKE_CORTEX_M0 TARGET_LPC11U34_421 TARGET_LPC11UXX TARGET_LPCTarget TARGET_M0 TARGET_MICRONFCBOARD TARGET_NXP
FEATURES_FOR_DEVICE :=
PERIPHERALS_FOR_DEVICE := DEVICE_ANALOGIN DEVICE_ERROR_PATTERN DEVICE_I2C DEVICE_I2CSLAVE DEVICE_INTERRUPTIN DEVICE_PORTIN DEVICE_PORTINOUT DEVICE_PORTOUT DEVICE_PWMOUT DEVICE_SERIAL DEVICE_SLEEP DEVICE_SPI DEVICE_SPISLAVE
...
GCC_DEFINES += -DAPPNEARME_MICRONFCBOARD -DCMSIS_VECTAB_VIRTUAL -DCMSIS_VECTAB_VIRTUAL_HEADER_FILE=\"cmsis_nvic.h\" -DLPC11U34_421
...
MICRONFCBOARD_LSCRIPT  ?= $(call find_target_linkscript,$(DEVICE_MBED_DIRS))
LSCRIPT := $(MICRONFCBOARD_LSCRIPT)

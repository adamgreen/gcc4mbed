...
MBED_DEVICE        := MTS_DRAGONFLY_F411RE
...
TARGETS_FOR_DEVICE := $(BUILD_TYPE_TARGET) TARGET_UVISOR_UNSUPPORTED TARGET_CORTEX_M TARGET_FAMILY_STM32 TARGET_LIKE_CORTEX_M4 TARGET_M4 TARGET_MTS_DRAGONFLY_F411RE TARGET_RTOS_M4_M7 TARGET_STM TARGET_STM32F4 TARGET_STM32F411RE
FEATURES_FOR_DEVICE :=
...
GCC_DEFINES += -DHSE_VALUE=26000000 -DRTC_LSI=1 -DTRANSACTION_QUEUE_SIZE_SPI=2 -DVECT_TAB_OFFSET=0x08010000

# Value: Tells the build system that the modem is on-board as oppose to a plug-in shield/module.
MTS_DRAGONFLY_F411RE_MODEM_ON_BOARD ?= "1"
GCC_DEFINES += -DMODEM_ON_BOARD=$(MTS_DRAGONFLY_F411RE_MODEM_ON_BOARD)

# Value: Defines how an on-board modem is wired up to the MCU, e.g., data connection can be a UART or USB and so forth.
MTS_DRAGONFLY_F411RE_MODEM_ON_BOARD_UART ?= "1"
GCC_DEFINES += -DMODEM_ON_BOARD_UART=$(MTS_DRAGONFLY_F411RE_MODEM_ON_BOARD_UART)
...
MTS_DRAGONFLY_F411RE_LSCRIPT  ?= $(call find_target_linkscript,$(DEVICE_MBED_DIRS))
LSCRIPT := $(MTS_DRAGONFLY_F411RE_LSCRIPT)

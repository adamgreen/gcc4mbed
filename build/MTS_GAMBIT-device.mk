...
TARGETS_FOR_DEVICE := $(BUILD_TYPE_TARGET) TARGET_UVISOR_UNSUPPORTED TARGET_CORTEX_M TARGET_FLASH_CMSIS_ALGO TARGET_Freescale TARGET_KPSDK_CODE TARGET_KPSDK_MCUS TARGET_KSDK2_MCUS TARGET_LIKE_CORTEX_M4 TARGET_M4 TARGET_MCUXpresso_MCUS TARGET_MCU_K64F TARGET_MTS_GAMBIT TARGET_RTOS_M4_M7
FEATURES_FOR_DEVICE :=
PERIPHERALS_FOR_DEVICE := DEVICE_FLASH DEVICE_I2C DEVICE_I2CSLAVE DEVICE_INTERRUPTIN DEVICE_PORTIN DEVICE_PORTINOUT DEVICE_PORTOUT DEVICE_RTC DEVICE_SERIAL DEVICE_SERIAL_ASYNCH DEVICE_SLEEP DEVICE_SPI DEVICE_SPISLAVE DEVICE_SPI_ASYNCH DEVICE_STDIO_MESSAGES
...
MTS_GAMBIT_LSCRIPT  ?= $(call find_target_linkscript,$(DEVICE_MBED_DIRS))
LSCRIPT := $(MTS_GAMBIT_LSCRIPT)

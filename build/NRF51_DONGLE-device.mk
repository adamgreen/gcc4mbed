...
TARGETS_FOR_DEVICE := $(BUILD_TYPE_TARGET) TARGET_UVISOR_UNSUPPORTED TARGET_CORTEX_M TARGET_LIKE_CORTEX_M0 TARGET_M0 TARGET_MCU_NORDIC_32K TARGET_MCU_NRF51 TARGET_MCU_NRF51822_UNIFIED TARGET_MCU_NRF51_32K TARGET_MCU_NRF51_32K_UNIFIED TARGET_MCU_NRF51_UNIFIED TARGET_NORDIC TARGET_NRF5 TARGET_NRF51_DONGLE TARGET_SDK11
FEATURES_FOR_DEVICE := FEATURE_BLE
PERIPHERALS_FOR_DEVICE := DEVICE_ERROR_PATTERN DEVICE_I2C DEVICE_I2C_ASYNCH DEVICE_INTERRUPTIN DEVICE_LOWPOWERTIMER DEVICE_PORTIN DEVICE_PORTINOUT DEVICE_PORTOUT DEVICE_PWMOUT DEVICE_RTC DEVICE_SERIAL DEVICE_SERIAL_ASYNCH DEVICE_SLEEP DEVICE_SPI DEVICE_SPISLAVE DEVICE_SPI_ASYNCH
...
GCC_DEFINES += -DBLE_STACK_SUPPORT_REQD -DCMSIS_VECTAB_VIRTUAL -DCMSIS_VECTAB_VIRTUAL_HEADER_FILE=\"cmsis_nvic.h\" -DNRF51 -DS130 -DSOFTDEVICE_PRESENT -DTARGET_MCU_NORDIC_32K -DTARGET_MCU_NRF51822 -DTARGET_MCU_NRF51_32K -DTARGET_NRF51822
...
NRF51_DONGLE_LSCRIPT  ?= $(call find_target_linkscript,$(DEVICE_MBED_DIRS))
LSCRIPT := $(NRF51_DONGLE_LSCRIPT)

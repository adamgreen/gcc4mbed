...
MBED_DEVICE        := NRF51_DONGLE_LEGACY
...
TARGETS_FOR_DEVICE := $(BUILD_TYPE_TARGET) TARGET_UVISOR_UNSUPPORTED TARGET_CORTEX_M TARGET_LIKE_CORTEX_M0 TARGET_M0 TARGET_MCU_NORDIC_32K TARGET_MCU_NRF51 TARGET_MCU_NRF51822 TARGET_MCU_NRF51_32K TARGET_NORDIC TARGET_NRF51_DONGLE TARGET_NRF51_DONGLE_LEGACY
...
GCC_DEFINES += -DCMSIS_VECTAB_VIRTUAL -DCMSIS_VECTAB_VIRTUAL_HEADER_FILE=\"cmsis_nvic.h\" -DNRF51 -DTARGET_MCU_NORDIC_32K -DTARGET_MCU_NRF51_32K -DTARGET_NRF51822
...
NRF51_DONGLE_LEGACY_LSCRIPT  ?= $(call find_target_linkscript,$(DEVICE_MBED_DIRS))
LSCRIPT := $(NRF51_DONGLE_LEGACY_LSCRIPT)

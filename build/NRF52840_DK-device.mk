...
TARGETS_FOR_DEVICE := $(BUILD_TYPE_TARGET) TARGET_UVISOR_UNSUPPORTED TARGET_CORTEX_M TARGET_LIKE_CORTEX_M4 TARGET_M4 TARGET_MCU_NRF52840 TARGET_NORDIC TARGET_NRF5 TARGET_NRF52840_DK TARGET_NRF52_COMMON TARGET_RTOS_M4_M7 TARGET_SDK13
FEATURES_FOR_DEVICE := FEATURE_BLE
PERIPHERALS_FOR_DEVICE := DEVICE_ANALOGIN DEVICE_ERROR_PATTERN DEVICE_FLASH DEVICE_I2C DEVICE_I2C_ASYNCH DEVICE_INTERRUPTIN DEVICE_LOWPOWERTIMER DEVICE_PORTIN DEVICE_PORTINOUT DEVICE_PORTOUT DEVICE_PWMOUT DEVICE_RTC DEVICE_SERIAL DEVICE_SERIAL_ASYNCH DEVICE_SERIAL_FC DEVICE_SLEEP DEVICE_SPI DEVICE_SPISLAVE DEVICE_TRNG
...
GCC_DEFINES += -DBLE_STACK_SUPPORT_REQD -DBOARD_PCA10056 -DCMSIS_VECTAB_VIRTUAL -DCMSIS_VECTAB_VIRTUAL_HEADER_FILE=\"cmsis_nvic.h\" -DCONFIG_GPIO_AS_PINRESET -DNRF52840_XXAA -DNRF52_ERRATA_20 -DNRF_DFU_SETTINGS_VERSION=1 -DNRF_SD_BLE_API_VERSION=5 -DS140 -DSOFTDEVICE_PRESENT -DSWI_DISABLE0 -DTARGET_NRF52840
...
NRF52840_DK_LSCRIPT  ?= $(call find_target_linkscript,$(DEVICE_MBED_DIRS))
LSCRIPT := $(NRF52840_DK_LSCRIPT)

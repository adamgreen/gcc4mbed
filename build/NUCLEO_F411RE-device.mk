...
TARGETS_FOR_DEVICE := $(BUILD_TYPE_TARGET) TARGET_UVISOR_UNSUPPORTED TARGET_CORTEX_M TARGET_FAMILY_STM32 TARGET_LIKE_CORTEX_M4 TARGET_M4 TARGET_NUCLEO_F411RE TARGET_RTOS_M4_M7 TARGET_STM TARGET_STM32F4 TARGET_STM32F411RE TARGET_STM32F411xE
FEATURES_FOR_DEVICE :=
...
NUCLEO_F411RE_CLOCK_SOURCE ?= "USE_PLL_HSE_EXTC|USE_PLL_HSE_XTAL|USE_PLL_HSI"
GCC_DEFINES += -DCLOCK_SOURCE=$(NUCLEO_F411RE_CLOCK_SOURCE)

# As 48 Mhz clock is configured for USB, SYSCLK has to be reduced from 100 to 96 MHz (set 0 for the max SYSCLK value)
NUCLEO_F411RE_CLOCK_SOURCE_USB ?= "0"
GCC_DEFINES += -DCLOCK_SOURCE_USB=$(NUCLEO_F411RE_CLOCK_SOURCE_USB)
...
NUCLEO_F411RE_LSCRIPT  ?= $(call find_target_linkscript,$(DEVICE_MBED_DIRS))

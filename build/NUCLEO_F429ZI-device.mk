...
TARGETS_FOR_DEVICE := $(BUILD_TYPE_TARGET) TARGET_UVISOR_UNSUPPORTED TARGET_CORTEX_M TARGET_FAMILY_STM32 TARGET_LIKE_CORTEX_M4 TARGET_M4 TARGET_NUCLEO_F429ZI TARGET_RTOS_M4_M7 TARGET_STM TARGET_STM32F4 TARGET_STM32F429 TARGET_STM32F429ZI TARGET_STM32F429xI TARGET_STM32F429xx
...
GCC_DEFINES += -DTRANSACTION_QUEUE_SIZE_SPI=2 -DUSBHOST_OTHER -DUSB_STM_HAL

# Value: PA_7 for the default board configuration, PB_5 in case of solder bridge update (SB121 off/ SB122 on)
NUCLEO_F429ZI_STM32_D11_SPI_ETHERNET_PIN ?= "PA_7"
GCC_DEFINES += -DSTM32_D11_SPI_ETHERNET_PIN=$(NUCLEO_F429ZI_STM32_D11_SPI_ETHERNET_PIN)

# Mask value : USE_PLL_HSE_EXTC | USE_PLL_HSE_XTAL (need HW patch) | USE_PLL_HSI
NUCLEO_F429ZI_CLOCK_SOURCE ?= "USE_PLL_HSE_EXTC|USE_PLL_HSE_XTAL|USE_PLL_HSI"
GCC_DEFINES += -DCLOCK_SOURCE=$(NUCLEO_F429ZI_CLOCK_SOURCE)

# As 48 Mhz clock is configured for USB, SYSCLK has to be reduced from 180 to 168 MHz (set 0 for the max SYSCLK value)
NUCLEO_F429ZI_CLOCK_SOURCE_USB ?= "1"
GCC_DEFINES += -DCLOCK_SOURCE_USB=$(NUCLEO_F429ZI_CLOCK_SOURCE_USB)
...
NUCLEO_F429ZI_LSCRIPT  ?= $(call find_target_linkscript,$(DEVICE_MBED_DIRS))
LSCRIPT := $(NUCLEO_F429ZI_LSCRIPT)

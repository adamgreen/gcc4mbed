...
TARGETS_FOR_DEVICE := $(BUILD_TYPE_TARGET) TARGET_UVISOR_UNSUPPORTED TARGET_CORTEX_M TARGET_FAMILY_STM32 TARGET_LIKE_CORTEX_M4 TARGET_M4 TARGET_NUCLEO_L476RG TARGET_RTOS_M4_M7 TARGET_STM TARGET_STM32L4 TARGET_STM32L476RG TARGET_STM32L476xG
FEATURES_FOR_DEVICE :=
...
# Mask value : USE_PLL_HSE_EXTC | USE_PLL_HSE_XTAL (need HW patch) | USE_PLL_HSI | USE_PLL_MSI (L4)
NUCLEO_L476RG_CLOCK_SOURCE ?= "USE_PLL_MSI"
GCC_DEFINES += -DCLOCK_SOURCE=$(NUCLEO_L476RG_CLOCK_SOURCE)
...
NUCLEO_L476RG_LSCRIPT  ?= $(call find_target_linkscript,$(DEVICE_MBED_DIRS))

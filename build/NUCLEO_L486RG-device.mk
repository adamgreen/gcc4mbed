...
TARGETS_FOR_DEVICE := $(BUILD_TYPE_TARGET) TARGET_UVISOR_UNSUPPORTED TARGET_CORTEX_M TARGET_FAMILY_STM32 TARGET_LIKE_CORTEX_M4 TARGET_M4 TARGET_NUCLEO_L486RG TARGET_RTOS_M4_M7 TARGET_STM TARGET_STM32L4 TARGET_STM32L486RG TARGET_STM32L486xG
FEATURES_FOR_DEVICE :=
...
GCC_DEFINES += -DMBEDTLS_CONFIG_HW_SUPPORT -DTRANSACTION_QUEUE_SIZE_SPI=2 -DUSBHOST_OTHER
...
NUCLEO_L486RG_LSCRIPT  ?= $(call find_target_linkscript,$(DEVICE_MBED_DIRS))
LSCRIPT := $(NUCLEO_L486RG_LSCRIPT)

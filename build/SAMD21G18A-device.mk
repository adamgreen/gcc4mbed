...
TARGETS_FOR_DEVICE := $(BUILD_TYPE_TARGET) TARGET_UVISOR_UNSUPPORTED TARGET_Atmel TARGET_CORTEX_M TARGET_LIKE_CORTEX_M0 TARGET_M0P TARGET_SAMD21 TARGET_SAMD21G18A TARGET_SAM_CortexM0P
FEATURES_FOR_DEVICE :=
...
GCC_DEFINES += -DEXTINT_CALLBACK_MODE=true -DI2C_MASTER_CALLBACK_MODE=true -DTC_ASYNC=true -DUSART_CALLBACK_MODE=true -D__SAMD21G18A__
...
SAMD21G18A_LSCRIPT  ?= $(call find_target_linkscript,$(DEVICE_MBED_DIRS))
LSCRIPT := $(SAMD21G18A_LSCRIPT)

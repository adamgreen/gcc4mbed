...
TARGETS_FOR_DEVICE := $(BUILD_TYPE_TARGET) TARGET_UVISOR_UNSUPPORTED TARGET_256K TARGET_CORTEX_M TARGET_EFM32 TARGET_EFR32MG1 TARGET_EFR32MG1P233F256GM48 TARGET_LIKE_CORTEX_M4 TARGET_M4 TARGET_RTOS_M4_M7 TARGET_SL_CRYPTO TARGET_SL_RAIL TARGET_Silicon_Labs TARGET_TB_SENSE_1
FEATURES_FOR_DEVICE :=
...
TB_SENSE_1_CORE_CLOCK_SOURCE ?= "HFXO"
GCC_DEFINES += -DCORE_CLOCK_SOURCE=$(TB_SENSE_1_CORE_CLOCK_SOURCE)

# Value: External crystal frequency in hertz
TB_SENSE_1_HFXO_FREQUENCY ?= "38400000"
GCC_DEFINES += -DHFXO_FREQUENCY=$(TB_SENSE_1_HFXO_FREQUENCY)

# Value: LFXO for external crystal, LFRCO for internal RC oscillator, ULFRCO for internal 1KHz RC oscillator
TB_SENSE_1_LOW_ENERGY_CLOCK_SOURCE ?= "LFXO"
GCC_DEFINES += -DLOW_ENERGY_CLOCK_SOURCE=$(TB_SENSE_1_LOW_ENERGY_CLOCK_SOURCE)

# Value: External crystal frequency in hertz
TB_SENSE_1_LFXO_FREQUENCY ?= "32768"
GCC_DEFINES += -DLFXO_FREQUENCY=$(TB_SENSE_1_LFXO_FREQUENCY)

# Value: Frequency in hertz, must correspond to setting of hfrco_band_select
TB_SENSE_1_HFRCO_FREQUENCY ?= "32000000"
GCC_DEFINES += -DHFRCO_FREQUENCY=$(TB_SENSE_1_HFRCO_FREQUENCY)
...
TB_SENSE_1_HFRCO_FREQUENCY_ENUM ?= "cmuHFRCOFreq_32M0Hz"
GCC_DEFINES += -DHFRCO_FREQUENCY_ENUM=$(TB_SENSE_1_HFRCO_FREQUENCY_ENUM)
...
TB_SENSE_1_LSCRIPT  ?= $(call find_target_linkscript,$(DEVICE_MBED_DIRS))
LSCRIPT := $(TB_SENSE_1_LSCRIPT)

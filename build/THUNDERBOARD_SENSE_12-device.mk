...
MBED_DEVICE        := THUNDERBOARD_SENSE_12
...
TARGETS_FOR_DEVICE := $(BUILD_TYPE_TARGET) TARGET_UVISOR_UNSUPPORTED TARGET_1024K TARGET_CORTEX_M TARGET_EFM32 TARGET_EFR32MG12 TARGET_EFR32MG12P332F1024GL125 TARGET_LIKE_CORTEX_M4 TARGET_M4 TARGET_RTOS_M4_M7 TARGET_SL_CRYPTO TARGET_SL_RAIL TARGET_Silicon_Labs TARGET_THUNDERBOARD_SENSE_12
FEATURES_FOR_DEVICE :=
...
THUNDERBOARD_SENSE_12_CORE_CLOCK_SOURCE ?= "HFXO"
GCC_DEFINES += -DCORE_CLOCK_SOURCE=$(THUNDERBOARD_SENSE_12_CORE_CLOCK_SOURCE)

# Value: External crystal frequency in hertz
THUNDERBOARD_SENSE_12_HFXO_FREQUENCY ?= "38400000"
GCC_DEFINES += -DHFXO_FREQUENCY=$(THUNDERBOARD_SENSE_12_HFXO_FREQUENCY)

# Value: LFXO for external crystal, LFRCO for internal RC oscillator, ULFRCO for internal 1KHz RC oscillator
THUNDERBOARD_SENSE_12_LOW_ENERGY_CLOCK_SOURCE ?= "LFXO"
GCC_DEFINES += -DLOW_ENERGY_CLOCK_SOURCE=$(THUNDERBOARD_SENSE_12_LOW_ENERGY_CLOCK_SOURCE)

# Value: External crystal frequency in hertz
THUNDERBOARD_SENSE_12_LFXO_FREQUENCY ?= "32768"
GCC_DEFINES += -DLFXO_FREQUENCY=$(THUNDERBOARD_SENSE_12_LFXO_FREQUENCY)

# Value: Frequency in hertz, must correspond to setting of hfrco_band_select
THUNDERBOARD_SENSE_12_HFRCO_FREQUENCY ?= "32000000"
GCC_DEFINES += -DHFRCO_FREQUENCY=$(THUNDERBOARD_SENSE_12_HFRCO_FREQUENCY)
...
THUNDERBOARD_SENSE_12_HFRCO_FREQUENCY_ENUM ?= "cmuHFRCOFreq_32M0Hz"
GCC_DEFINES += -DHFRCO_FREQUENCY_ENUM=$(THUNDERBOARD_SENSE_12_HFRCO_FREQUENCY_ENUM)
...
THUNDERBOARD_SENSE_12_LSCRIPT  ?= $(call find_target_linkscript,$(DEVICE_MBED_DIRS))
LSCRIPT := $(THUNDERBOARD_SENSE_12_LSCRIPT)

...
TARGETS_FOR_DEVICE := $(BUILD_TYPE_TARGET) TARGET_UVISOR_UNSUPPORTED TARGET_CORTEX_M TARGET_LIKE_CORTEX_M0 TARGET_M0 TARGET_MCU_NORDIC_32K TARGET_MCU_NRF51 TARGET_MCU_NRF51822 TARGET_MCU_NRF51_32K TARGET_MCU_NRF51_32K_BOOT TARGET_NORDIC TARGET_TY51822R3 TARGET_TY51822R3_BOOT
...
GCC_DEFINES += -DCMSIS_VECTAB_VIRTUAL -DCMSIS_VECTAB_VIRTUAL_HEADER_FILE=\"cmsis_nvic.h\" -DNRF51 -DTARGET_MCU_NORDIC_32K -DTARGET_MCU_NRF51_32K -DTARGET_MCU_NRF51_32K_BOOT -DTARGET_NRF51822 -DTARGET_NRF_32MHZ_XTAL -DTARGET_OTA_ENABLED -DTARGET_TY51822R3
...
TY51822R3_BOOT_LSCRIPT  ?= $(call find_target_linkscript,$(DEVICE_MBED_DIRS))
LSCRIPT := $(TY51822R3_BOOT_LSCRIPT)

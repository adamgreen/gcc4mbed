...
TARGETS_FOR_DEVICE := $(BUILD_TYPE_TARGET) TARGET_UVISOR_UNSUPPORTED TARGET_CORTEX_M TARGET_FLASH_CMSIS_ALGO TARGET_LIKE_CORTEX_M3 TARGET_LPC176X TARGET_LPCTarget TARGET_M3 TARGET_NXP TARGET_UBLOX_C027
FEATURES_FOR_DEVICE := FEATURE_LWIP
PERIPHERALS_FOR_DEVICE := DEVICE_ANALOGIN DEVICE_ANALOGOUT DEVICE_CAN DEVICE_DEBUG_AWARENESS DEVICE_ERROR_RED DEVICE_ETHERNET DEVICE_FLASH DEVICE_I2C DEVICE_I2CSLAVE DEVICE_INTERRUPTIN DEVICE_PORTIN DEVICE_PORTINOUT DEVICE_PORTOUT DEVICE_PWMOUT DEVICE_RTC DEVICE_SERIAL DEVICE_SERIAL_FC DEVICE_SLEEP DEVICE_SPI DEVICE_SPISLAVE DEVICE_STDIO_MESSAGES
...
UBLOX_C027_MODEM_ON_BOARD ?= "1"
GCC_DEFINES += -DMODEM_ON_BOARD=$(UBLOX_C027_MODEM_ON_BOARD)

# Value: Defines how the modem is wired up to the MCU, e.g., data connection can be a UART or USB and so forth.
UBLOX_C027_MODEM_ON_BOARD_UART ?= "1"
GCC_DEFINES += -DMODEM_ON_BOARD_UART=$(UBLOX_C027_MODEM_ON_BOARD_UART)

...
TARGETS_FOR_DEVICE := $(BUILD_TYPE_TARGET) TARGET_UVISOR_UNSUPPORTED TARGET_CORTEX_M TARGET_FLASH_CMSIS_ALGO TARGET_LIKE_CORTEX_M4 TARGET_M4 TARGET_RTOS_M4_M7 TARGET_STM TARGET_STM32F4 TARGET_STM32F439 TARGET_STM32F439ZI TARGET_STM32F439xx TARGET_UBLOX_EVK_ODIN_W2
FEATURES_FOR_DEVICE := FEATURE_LWIP
PERIPHERALS_FOR_DEVICE := DEVICE_ANALOGIN DEVICE_CAN DEVICE_EMAC DEVICE_FLASH DEVICE_I2C DEVICE_I2CSLAVE DEVICE_INTERRUPTIN DEVICE_PORTIN DEVICE_PORTINOUT DEVICE_PORTOUT DEVICE_PWMOUT DEVICE_SERIAL DEVICE_SLEEP DEVICE_SPI DEVICE_SPISLAVE DEVICE_STDIO_MESSAGES DEVICE_TRNG
...
GCC_DEFINES += -DCB_CHIP_WL18XX -DCB_INTERFACE_SDIO -DHSE_STARTUP_TIMEOUT=5000 -DHSE_VALUE=24000000 -DMBEDTLS_ARC4_C -DMBEDTLS_DES_C -DMBEDTLS_MD4_C -DMBEDTLS_MD5_C -DMBEDTLS_SHA1_C -DSUPPORT_80211D_ALWAYS -DWLAN_ENABLED
...
UBLOX_EVK_ODIN_W2_LSCRIPT  ?= $(call find_target_linkscript,$(DEVICE_MBED_DIRS))
LSCRIPT := $(UBLOX_EVK_ODIN_W2_LSCRIPT)

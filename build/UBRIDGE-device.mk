...
TARGETS_FOR_DEVICE := $(BUILD_TYPE_TARGET) TARGET_UVISOR_UNSUPPORTED TARGET_CORTEX_M TARGET_FRDM TARGET_Freescale TARGET_K82F TARGET_KSDK2_MCUS TARGET_LIKE_CORTEX_M4 TARGET_M4 TARGET_MCUXpresso_MCUS TARGET_RTOS_M4_M7 TARGET_UBRIDGE
FEATURES_FOR_DEVICE :=
...
GCC_DEFINES += -DCPU_MK82FN256VDC15 -DFSL_RTOS_MBED
...
UBRIDGE_LSCRIPT  ?= $(call find_target_linkscript,$(DEVICE_MBED_DIRS))
LSCRIPT := $(UBRIDGE_LSCRIPT)
